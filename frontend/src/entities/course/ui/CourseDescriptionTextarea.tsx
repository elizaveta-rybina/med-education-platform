...
interface CourseDescriptionTextareaProps
...
export const CourseDescriptionTextarea = ({
	register,
	errors,
	success = false,
	error = false,
	hint,
	...props
}: CourseDescriptionTextareaProps) => {
	const errorMessage =
		typeof error === 'string' ? error : errors.description?.message
	const hasError = Boolean(error) || Boolean(errors.description)
