	...
	return (
		<div>
			<CourseTitle
				...
				imageAlt={t('info.imageAlt')}
				imageSrc={courseImage}
			/>
			<div className='flex justify-between my-15'>
				<ModuleInfo
					topText={t('info.modules.top')}
					bottomText={t('info.modules.bottom')}
				/>
				<ModuleInfo
					topText={t('info.time.top')}
					bottomText={t('info.time.bottom')}
				/>
				<ModuleInfo
					topText={t('info.course.top')}
					bottomText={t('info.course.bottom')}
				/>
			</div>
