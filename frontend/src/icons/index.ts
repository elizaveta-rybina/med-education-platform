...
import { ReactComponent as ExamIcon } from "./exam.svg?react"
...
export {
  ...
  ArrowRightIcon, ArrowUpIcon, AudioIcon, BoltIcon, BookIcon, BoxCubeIcon, BoxIcon, BoxIconLine, CalenderIcon, ChatIcon, CheckCircleIcon, CheckLineIcon, ChevronDownIcon, ChevronLeftIcon, ChevronUpIcon, CloseIcon, CloseLineIcon, CopyIcon, DocsIcon, DollarLineIcon, DownloadIcon, EnvelopeIcon, ErrorHexaIcon, ErrorIcon, ExamIcon, EyeCloseIcon, EyeIcon, FileIcon, FolderIcon, GridIcon, GroupIcon, HorizontaLDots, InfoIcon, ListIcon, LockIcon, MailIcon, MoreDotIcon, PageIcon, PaperPlaneIcon, PencilIcon, PieChartIcon, PlugInIcon, PlusIcon, SettingIcon, ShootingStarIcon, TableIcon, TaskIcon, TeacherIcon, TimeIcon, TrashBinIcon, UserCircleIcon, UserIcon, VideoIcon
}
